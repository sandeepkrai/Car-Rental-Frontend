          ...
          itemBuilder: (BuildContext context, int index) {
            return Container(
              ...
              child: ListTile(
                  ...
                  subtitle: Row(
                    children: [
                      Text("₹"+widget.bookings[index].cost.toString(), style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500, fontSize: height*0.0155),),
                      SizedBox(
                        width: width*0.04,
                      ),
                      Text(DateFormat.MEd().format(widget.bookings[index].startDate), style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500, fontSize: height*0.0155)),
